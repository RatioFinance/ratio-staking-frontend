    ...
    <>
      <InputGroup className={classNames('customInput mb-1', className)}>
        <FormControl
          ...
          className={classNames({ onlytext: appendStr === '' }, 'font-poppins font-regular')}
          readOnly={readOnly}
        />
        <p
          className={classNames('tokenName', { 'tokenName--onlytext': appendStr === '' }, 'font-poppins font-regular')}
        >
          {tokenStr}
        </p>
        {appendStr !== '' && (
          <InputGroup.Append onClick={setMaxValue}>
            <InputGroup.Text id="customInput" className="font-poppins font-regular">
              {appendStr}
            </InputGroup.Text>
          </InputGroup.Append>
        )}
